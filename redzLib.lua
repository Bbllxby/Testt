local Configs_HUB = {
  ...
  Cor_Stroke = Color3.fromRGB(25, 25, 25),
...
local function TextSetColor(instance)
  instance.MouseEnter:Connect(function()
    CreateTween(instance, "TextColor3", Color3.fromRGB(255, 255, 255), 0.4, true)
  end)
...
function MakeNotifi(Configs)
  local Title = Configs.Title or "Blxb Hub"
...
function MakeWindow(Configs)
  local title = Configs.Hub.Title or "Blxb Hub v2"
  local Anim_Title = Configs.Hub.Animation or "By Blxbby"
  ...
  function AddButton(parent, Configs)
    ...
    TextButton.MouseButton1Click:Connect(function()
      Callback("Click!!")
      CreateTween(ImageLabel, "ImageColor3", Color3.fromRGB(255, 255, 255), 0.2, true)
  ...
  function AddToggle(parent, Configs)
    ...
    if Default then
      ...
      CreateTween(Frame2, "BackgroundColor3", Color3.fromRGB(255, 255, 255), 0.2, false)
      CreateTween(Stroke, "Color", Color3.fromRGB(255, 255, 255), 0.2, false)
      CreateTween(TextLabel, "TextColor3", Color3.fromRGB(255, 255, 255), 0.2, false)
    end
    Callback(OnOff)
    TextButton.MouseButton1Click:Connect(function()
  ...
  function AddDiscord(parent, Configs)
    ...
    local DiscordIcon = Configs[2] or Configs.DiscordIcon or "rbxassetid://17184926194"
